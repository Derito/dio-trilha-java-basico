...
public class Problem {
    public static void main(String[] args) {
    	...
    	for (int i = 0; i < N; i++) {
    		...
    		else if (jogador2.equalsIgnoreCase("ataque")&& jogador1.equalsIgnoreCase("papel")) System.out.println("Jogador2 venceu");
    		else if (jogador2.equalsIgnoreCase("papel")&& jogador1.equalsIgnoreCase("pedra")) System.out.println( "Jogador1 venceu");
    		else if (jogador1.equalsIgnoreCase("papel")&& jogador2.equalsIgnoreCase("pedra")) System.out.println("Jogador2 venceu");
    		else System.out.println( "Ambos perderam");
            leitor.close();
    	}
    }
}